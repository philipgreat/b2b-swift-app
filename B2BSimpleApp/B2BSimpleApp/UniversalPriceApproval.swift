...
extension UniversalPriceApproval: Mappable{
...
extension UniversalPriceApproval:CustomStringConvertible{
	...
	var description: String{
		...
		var result = "universal_price_approval{";
